...
Our code includes a UI folder which includes the code for our interactive demonstration website. This allows a user to review pairs of records and assess for themselves if they think the two records correspond to the same person. This emulates the role of a reviewer. The interactive demonstration can be found using [this link](https://tinyurl.com/pinformatics-mindfirl). 

A tutorial how to use the website can be found in [this slide deck](https://docs.google.com/presentation/d/17lMvtYwHsAaMQuxeB_VL7GkSBisKiyqW/edit?slide=id.g35f3427c0fe_0_6#slide=id.g35f3427c0fe_0_6).
